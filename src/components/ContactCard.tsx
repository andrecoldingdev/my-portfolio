...
import { FaGithub, FaLinkedin, FaDiscord, FaVoicemail, FaMailBulk, FaMailchimp } from 'react-icons/fa';
            ...
            <div className="bg-transparent border p-8 rounded-lg shadow-lg text-white w-full md:max-w-4xl mx-auto mt-8 cc-bg blur-background w-4/5">
                <div className="flex justify-between items-center">
                    ...
                    <div className="flex space-x-4">
                        ...
                        <a href="mailto:mal.col.dev333@gmail.com" target="_blank" rel="noreferrer" className="hover:text-gray-200">
                        <FaMailchimp size={44} />
                        </a>
                    </div>
                </div>
